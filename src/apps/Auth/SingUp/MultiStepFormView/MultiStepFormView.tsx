...
const MultiStepFormView = () => {
  ...
  return (
    <div className="mx-auto w-full min-h-screen flex flex-col justify-center  px-4  sm:px-6 lg:px-8 bg-[--background-dark-blue] overflow-hidden relative">
      <Header />
      <div className="h-full w-full flex justify-center items-center mt-10">
        <div className="flex flex-col w-full 2xl:max-w-screen-xl justify-between rounded-[32px]  bg-[--background-soft-blue] items-center">
          {/* <span
            role="progressbar"
          ...
          <div className="lg:flex md:flex-grow gap-12 w-full h-full justify-center items-center px-10 py-10">
            <StepsCard
              circle={circle}
      ...
      >
        <div className="relative w-[530px] px-3 pr-10 py-6 mx-auto dark:bg-[--background-dark-blue] bg-[--text-body] rounded-[16px] shadow-lg z-50 border-2 border-[--text-light-body]">
          <div className="flex justify-between items-center gap-4 text-center sm:ml-4 sm:text-left">
            <div>
              ...
              <p className="mt-2 text-sm text-[--text-body] max-w-[356px]">
            ...
            />
            {/* <button
                className="p-2.5  text-white rounded-md outline-none border "
                onClick={() => {
                  setShowModal(false);
                }}
              >
